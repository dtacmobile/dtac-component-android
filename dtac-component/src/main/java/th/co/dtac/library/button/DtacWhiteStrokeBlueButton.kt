...
class DtacWhiteStrokeBlueButton : DtacButton {
    ...
    private fun setupProperties() {
        ...
        background = ResourcesCompat.getDrawable(context.resources, R.drawable.bg_white_stroke_blue_radius_4_selector, null)
    }
